...
- **Git ビュー** — cwd が Git リポジトリのとき、メイン画面上部に「ターミナル / Git」のタブが出て切り替え可能。ブランチの一覧 / 切り替え / 作成と、作業ツリーの diff 表示。
...
これらの割り当てはサイドバー下部の「⚙ ショートカット設定」から変更できます(変更内容はローカルに保存されます)。タブ名はサイドバーのタブをダブルクリックで変更できます。
